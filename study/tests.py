...
class LessonCRUDTestCase(APITestCase):
    ...
    def setUp(self):
        self.owner = CustomUser.objects.create_user(
            username="owner_user", email="owner@example.com", password="ownerpass123"
        )

        self.user = CustomUser.objects.create_user(
            username="regular_user", email="regular@example.com", password="userpass123"
        )

        self.course = Course.objects.create(
            title="Test Course", description="Test Course Description", owner=self.owner
        )
...
class SubscribeTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = CustomUser.objects.create_user(
            username="regular_user", email="user@example.com", password="userpass123"
        )
    ...
    def test_subscribe_remove(self):
        Subscribe.objects.create(user=self.owner, course=self.course)
